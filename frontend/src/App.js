...
import "./index.css";
import { MdArrowBackIos } from "react-icons/md"; // Иконка назад
import { FaTelegram } from "react-icons/fa"; // Иконка Telegram
import { LuShoppingCart } from "react-icons/lu"; // Иконка корзины
import { MdOutlineDelete } from "react-icons/md"; // Иконка очистить
