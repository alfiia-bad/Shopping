        ...
        with conn.cursor() as cursor:
            ...
            if cursor.fetchone()[0] == 0:
                initial_products = [
                    ...
                    ("72", "Шоколадка Ritter-Sport", "ritter_sport.jpg", "Снеки"),
                    ("73", "Сливки 20%", "cream.webp", "Напитки"),
                    ("74", "Стиральный порошок", "powder.webp", "Личная гигиена"),
                    ("75", "Соль гималайская солонка", "salt_small.webp", "Специи")
                ]
